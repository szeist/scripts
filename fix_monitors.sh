...
if [ $DISPLAYPORT_COUNT -eq 2 ]; then
    xrandr --output DP-2-1 --above eDP-1 --mode 1920x1080
    xrandr --output DP-2-2 --above eDP-1 --left-of DP-2-1 --mode 1920x1080;
fi

if [ $HDMI_COUNT -eq 1 ]; then
    xrandr --output HDMI-2 --above eDP-1 --mode 1920x1080
fi
